...
- (void)didAddSubview:(UIView *)subview
{
  ...
  react_native_assert(!_decorator.isAttached && "MarkdownTextInputDecoratorComponentView tried to add TextInput observers while they were attached");
...
{
  react_native_assert(!_decorator.isAttached && "MarkdownTextInputDecoratorComponentView was being recycled with TextInput observers still attached");
