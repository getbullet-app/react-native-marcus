...
test("empty string", () => {
  expect("").toBeParsedAsHTML(
    '<p data-type="line" data-id="0"><span data-type="br" data-id="0,0"><br data-id="0,0,0"></span></p>',
  )
})

test("no formatting", () => {
  expect("Hello, world!").toBeParsedAsHTML(
    '<p data-type="line" data-id="0"><span data-type="text" data-id="0,0">Hello, world!</span></p>',
  )
})
