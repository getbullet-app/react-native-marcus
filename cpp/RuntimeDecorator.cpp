...
void injectJSIBindings(jsi::Runtime &rt) {
  ...
  rt.global().setProperty(
      rt, "jsi_setMarkdownRuntime",
      jsi::Function::createFromHostFunction(
          rt, jsi::PropNameID::forAscii(rt, "jsi_setMarkdownRuntime"), 1,
  ...
  rt.global().setProperty(
      rt, "jsi_registerMarkdownWorklet",
      jsi::Function::createFromHostFunction(
          rt, jsi::PropNameID::forAscii(rt, "jsi_registerMarkdownWorklet"), 1,
          [](jsi::Runtime &rt, const jsi::Value &thisValue,
             const jsi::Value *args, size_t count) -> jsi::Value {
  ...
  rt.global().setProperty(
      rt, "jsi_unregisterMarkdownWorklet",
      jsi::Function::createFromHostFunction(
          rt, jsi::PropNameID::forAscii(rt, "jsi_unregisterMarkdownWorklet"), 1,
          [](jsi::Runtime &rt, const jsi::Value &thisValue,
             const jsi::Value *args, size_t count) -> jsi::Value {
